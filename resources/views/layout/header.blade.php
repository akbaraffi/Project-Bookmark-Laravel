<header class="flex fixed top-0 w-full justify-between items-center p-4 bg-black text-white gap-3">
...
<ul class="flex gap-4 pr-5 font-medium">
    ...
    <li><a href="{{ url('/form') }}" class="hover:text-gray-300 transition">Tambah</a></li>
    <li><a href="{{ url('/table') }}" class="hover:text-gray-300 transition">Daftar Bookmark</a></li>
